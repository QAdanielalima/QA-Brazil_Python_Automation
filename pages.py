...
class UrbanRoutesPage:
    # Adicionando os localizadores From e To
    ...
    switch_blanket = (By.XPATH, "//div[contains(text(), 'Cobertor e lençóis')]/following-sibling::div[1]/div/span")
    ...
    #Finalizar chamando o Taxi
    click_taxi_button = (By.CSS_SELECTOR, '.smart-button')
    ...
    # Criando funções para ler os valores
    ...
    def add_coment(self, coment):
        self.driver.find_element(*self.add_comment).send_keys(coment)
    ...
    def calling_taxi(self):
        self.driver.find_element(*self.click_taxi_button).click()
